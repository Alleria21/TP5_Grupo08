...
public class ListaBeca {
	...
	public ListaBeca() {
		...
		Curso curso2= new Curso(1,"INGLES", "Ingles Inicial",LocalDate.parse("2022-08-05"), LocalDate.parse("2022-08-05"), 233, "Virtual", docente1);
		Curso curso3= new Curso(2,"PROGRAMACION", "Programacion Inicial",LocalDate.parse("2022-08-05"), LocalDate.parse("2022-08-05"), 235, "Virtual", docente2);
		Curso curso4= new Curso(3,"ALGEBRA", "Algebra I",LocalDate.parse("2022-08-05"), LocalDate.parse("2022-08-05"), 237, "Precencial", docente3);
