...
public class ListaBecas {
	...
	public ListaBecas() {
		...
		becas.add(new Beca(1, curso2, "2022-08-05","2020-09-05","Abierto"));
		becas.add(new Beca(2, curso3, "2022-08-05","2020-09-05","Abierto"));
		becas.add(new Beca(3, curso4, "2022-08-05","2020-09-05","Abierto"));
	}
